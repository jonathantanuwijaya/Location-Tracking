...
import 'package:tracking_practice/core/interfaces/i_location_time_summary_repository.dart';
import 'package:tracking_practice/models/location_time_summary.dart';

/// Implementation of [ILocationTimeSummaryRepository]
/// that manages location time summary data stream from background service
class LocationTimeSummaryRepository implements ILocationTimeSummaryRepository {
  ...
  void startListeningToLocationUpdates() {
    _backgroundService
        .on(ServicePortKey.updateLocationSummary)
        .listen(
